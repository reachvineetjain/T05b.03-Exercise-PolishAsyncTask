...
public class MainActivity extends AppCompatActivity implements
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            // TODO (1)- DONE Create a String member variable called mGithubJson that will store the raw JSON
            String mGithubJson;
            @Override
            ...
            // TODO (3)- DONE Override deliverResult and store the data in mGithubJson
            @Override
            public void deliverResult(String data) {
                mGithubJson = data;
                // TODO (4)- DONE Call super.deliverResult after storing the data
